...
📧 rachel.kim@university.edu | 📱 (555) 345-9012  
🏛️ Department of Computer Science, Tech University  
🔗 [rachelmkim.com](https://rachelmkim.com) | 📚 [Google Scholar](https://scholar.google.com/rachelmkim)
...
4. **Kim, R.**, et al. (2024). "Efficient Few-Shot Learning for Multilingual Models." *Annual Meeting of the Association for Computational Linguistics (ACL)*. Bangkok, Thailand. [Acceptance Rate: 22%]

5. Lee, S. & **Kim, R.** (2023). "Adversarial Training for Robust NLP Models." *Conference on Empirical Methods in Natural Language Processing (EMNLP)*. Singapore. [Acceptance Rate: 24%]

6. **Kim, R.**, Martinez, A., & Chen, L. (2023). "Language-Agnostic Representation Learning." *International Conference on Learning Representations (ICLR)*. Kigali, Rwanda. [Acceptance Rate: 31%]

7. **Kim, R.** & Manning, C. (2022). "Unsupervised Cross-Lingual Alignment of Word Embeddings." *North American Chapter of the ACL (NAACL)*. Seattle, WA. [Acceptance Rate: 25%]

8. **Kim, R.**, et al. (2021). "Transfer Learning for Low-Resource Neural Machine Translation." *Annual Meeting of the ACL*. Virtual Conference. [**Best Paper Award**]

9. Chen, L., **Kim, R.**, & Manning, C. (2020). "Multilingual BERT for Cross-Lingual Understanding." *EMNLP*. Virtual Conference.

10. **Kim, R.** & Barzilay, R. (2019). "Semi-Supervised Learning for Neural NLP." *ACL*. Florence, Italy.
...
*This CV was created using markdown and converted to PDF at [MarkdownResume.app](https://markdownresume.app)*